...
class Categories_Products(peewee.Model):
  category = peewee.ForeignKeyField(Category,related_name='categories')
  product = peewee.ForeignKeyField(Category,related_name='products')
